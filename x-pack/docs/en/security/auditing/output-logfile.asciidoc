...
- The fields of a log entry are ordered. However, if a field does not have a value it
  will not be printed. The precise line pattern, together with the absolute field
...
- A field's value, request's body as well, will be escaped as per the JSON RFC 4627.
