...
public final class RestrictedIndicesNames {
    ...
    public static final String SECURITY_TOKENS_INDEX_NAME = ".security-tokens";

    public static final Set<String> RESTRICTED_NAMES = Collections.unmodifiableSet(Sets.newHashSet(SECURITY_INDEX_NAME,
            INTERNAL_SECURITY_INDEX_6, INTERNAL_SECURITY_INDEX_7, SECURITY_TOKENS_INDEX_NAME, INTERNAL_SECURITY_TOKENS_INDEX_7));
